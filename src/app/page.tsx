...
export default function Home() {
  ...
  const [tab, setTab] = useState<"visao" | "despesas" | "cartoes" | "analises">(
    "visao",
  );
  ...
  return (
    <main className="portal">
      <aside className="sidebar">
        <button className="brand" type="button" onClick={() => setTab("visao")} aria-label="Ir para a visão geral de Finanças">
